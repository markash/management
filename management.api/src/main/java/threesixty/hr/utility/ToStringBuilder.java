...
public class ToStringBuilder {
	...
	/**
	 * Appends the given {@code Object} value depending on the given
	 * <code>appendIfNull</code> argument.
	 *
	 * @return <code>this</code> supporting the fluent API
	 */
	...
	/**
	 * Appends the given {@code String} value depending on the given
	 * <code>appendIfNullOrEmpty</code> argument.
	 *
	 * @return <code>this</code> supporting the fluent API
	 */
	...
	/**
	 * Appends the given {@code varArg} values; <code>null</code> values are
	 * filtered; multiple values are separated by comma.
	 *
	 * @return <code>this</code> supporting the fluent API
	 */
	...
	/**
	 * Appends the given {@code Collection} values; <code>null</code> values are
	 * filtered; multiple values are separated by comma.
	 *
	 * @return <code>this</code> supporting the fluent API
	 */
	...
	/**
	 * Appends the given {@code Collection} values; <code>null</code> values are
	 * filtered; multiple values are separated by comma; if empty, the collection is
	 * only appended if <code>appendIfEmpty</code> is set to <code>true</code>.
	 *
	 * @return <code>this</code> supporting the fluent API
	 */
	...
	/**
	 * Creates the identifier for the given {@link Object} consisting of the simple
	 * class name and (if "includeHashCode" is <code>true</code>) the hash code.
	 */
	...
	/**
	 * Resolves the class to be displayed for the given instance. For anonymous
	 * classes, the superclass or interface is returned.
	 */
