...
import threesixty.hr.management.client.Desktop.UserProfileMenu.ThemeMenu.DarkThemeMenu;
import threesixty.hr.management.client.Desktop.UserProfileMenu.ThemeMenu.DefaultThemeMenu;
import threesixty.hr.management.client.outline.SearchOutline;
import threesixty.hr.management.client.outline.SettingsOutline;
import threesixty.hr.management.client.outline.WorkOutline;
...
public class Desktop extends AbstractDesktop {
	...
	protected String getConfiguredDisplayStyle() {
		...
		String value = 
	    		ClientUIPreferences.getClientPreferences(ClientSession.get())
	    			.get(ClientPreferences.PREF_DESKTOP_DISPLAY_STYLE.name(), IDesktop.DISPLAY_STYLE_DEFAULT);
